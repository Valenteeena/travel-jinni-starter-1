    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.header}>
                <div>
                    <p className="text-sm phone:text-xs">Remaining Days to my Trip</p>

                    <div className="flex">
                        <div className="flex-col text-center mx-1 w-10 phone:w-6">
                        ...
                        <div className="flex-col text-center mx-1 w-10 phone:w-8">
                ...
                <div className="flex text-sm py-5 phone:py-4">
            ...
            <div className={styles.content}>
                <div className={styles.leftSide}>
                    <h1 className="font-bold text-xl font-serif py-1 phone:text-sm">
                        Six Days In Dubai
                    </h1>
                    <ul>
                ...
                <div>
                    <div className={styles.rightSide}>
                        <div className="rounded-full w-20 h-20 p-2 flex items-center justify-center bg-white phone:w-12 phone:h-12">
                            <img src="/logo.png" alt="logo" className="w-18 h-18 rounded-full " />
                        </div>
                        <div className="ml-4 text-center border border-white">
                            <h1 className="head-t font-bold font-mono tracking-wide px-3 phone:text-2xl">
                                HILTON HOTEL
                            </h1>
                            <h2 className="bg-white text-black text-xl pb-1 phone:text-sm">
                                POWERED BY TRAVEL JINNI
                            </h2>
                        </div>
                    </div>
                    <div className={`div-w blur-filter ${styles.conBody}`}>
                        <h1 className="text-5xl font-serif font-bold pb-5 px-4 phone:text-3xl">
                            Your Trip Awaits You!
                        </h1>
                        <p className="text-sm pb-5 phone:text-xs">
